           ...
           //console.log(response);
              ...
              jQuery('#size_options').html('');
               ...
               var extra_optionals = '';
                ...
                extra_optionals =  response.extra_optionals;

                            

              if(response.extra_optionals ) {
        ...
        jQuery.ajax({
           ...
           success: function(response) {             
              ...
              if(response){
                 ...
                 if(response.options_name) {
                    ...
                    jQuery.each( response.options_name, function( i, item ) {
                       ...
                       if(item.type == 'reuirebook'){
                          ...
                          jQuery('#ess_amount').append('<p><strong>$'+ item.opt_price +'</strong> '+ item.opt_name +'</p>');
                 ...
                 if(response.postid == '248' || response.postid == '443' || response.postid == '1204' || response.postid == '1203' || response.postid == '1198' || response.postid == '1197') {
                    jQuery('#order-detail td#insamount').html('Includes First 3 Months');
                 }else if(response.postid == '1213' || response.postid == '1195'){
                    jQuery('#order-detail td#insamount').html('Includes First 4 Months');
                 }else{
